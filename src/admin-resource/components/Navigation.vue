        ...
        <nav class="hidden md:flex space-x-10">
          <div class="relative">
            <button
              ...
              aria-expanded="false"
              :class="[{ 'text-gray-900': isActive.product }]"
            ...
            >
              ...
              <svg
                ...
                fill="currentColor"
                aria-hidden="true"
                :class="[{ 'text-gray-600': isSelect.product }]"
              >
                <path
                  fill-rule="evenodd"
          ...
          <a
            ...
            :class="[{ 'text-gray-900': isActive.order }]"
          >
            Order
          </a>
          ...
          <a
            href="#"
            class="text-base font-medium text-gray-500 hover:text-gray-900"
            :class="[{ 'text-gray-900': isActive.customer }]"
          >
            Customer
          </a>
          ...
          <a
            href="#"
            class="text-base font-medium text-gray-500 hover:text-gray-900"
            :class="[{ 'text-gray-900': isActive.image }]"
          >
            Image
          </a>
          ...
          <div class="relative">
            <button
              type="button"
              class="text-gray-500 group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              :class="[{ 'text-gray-900': isActive.mail }]"
              aria-expanded="false"
              @click="toggleMenu('mail')"
            >
              <span>Mail</span>
              <svg
                class="text-gray-400 ml-2 h-5 w-5 group-hover:text-gray-500"
                ...
                fill="currentColor"
                aria-hidden="true"
                :class="[{ 'text-gray-600': isSelect.mail }]"
              >
                <path
                  fill-rule="evenodd"
                  d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
          ...
          <a
            href="#"
            class="text-base font-medium text-gray-500 hover:text-gray-900"
            :class="[{ 'text-gray-900': isActive.csv }]"
          >
            CSV
          </a>
          ...
          <div class="relative">
            ...
            >
              ...
              <svg
                ...
                fill="currentColor"
                aria-hidden="true"
                :class="[{ 'text-gray-600': isSelect.analytics }]"
              >
                <path
                  fill-rule="evenodd"
                  d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
          ...
          <div class="relative">
            <button
              type="button"
              class="text-gray-500 group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              :class="[{ 'text-gray-900': isActive.setting }]"
              aria-expanded="false"
            ...
            >
              ...
              <svg
                ...
                fill="currentColor"
                aria-hidden="true"
                :class="[{ 'text-gray-600': isSelect.setting }]"
              >
                <path
                  fill-rule="evenodd"
                  d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
          ...
          <div class="relative">
            <button
              ...
              class="text-gray-500 group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              aria-expanded="false"
              :class="[{ 'text-gray-900': isActive.more }]"
            ...
            >
              ...
              <svg
                ...
                fill="currentColor"
                aria-hidden="true"
                :class="[{ 'text-gray-600': isSelect.more }]"
              >
                <path
                  fill-rule="evenodd"
                  d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
...
export default defineComponent({
  ...
  setup() {
    ...
    if (route.value.name) {
      isActive[route.value.name] = true
    }

    const toggleMenu = (name: string) => {
      Object.keys(isSelect.value).forEach((key: string) => {
        isSelect[key] = key === name ? !isSelect[name] : false
      })
    }

    return { isSelect, isActive, toggleMenu, signOut }
  },
})
</script>
